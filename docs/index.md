...
This project is primarily aimed at the City Council of Vancouver, as we chose Vancouver as the location for our study. The final work will be publicly available for other officials from all over the globe to learn from. We hope this research will prompt a new way of dealing with graffiti before it occurs. For example, city planners may use the information to design graffiti proof cities and mitigate or solve current graffiti related problems. Technical details about the methodology can be found in our report on [github](https://github.com/CowKeyMan/PredictingGraffitiUsingCityLayouts), with the hopes of inspiring other researchers to explore this area further.
